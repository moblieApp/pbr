...
class CalculatorIf : virtual public  ::shared::SharedServiceIf {
 public:
  ...
  virtual void addpicture(std::string& _return, const std::string& imagefile, const int32_t cover) = 0;
...
typedef struct _Calculator_addpicture_args__isset {
  _Calculator_addpicture_args__isset() : imagefile(false), cover(false) {}
  bool imagefile :1;
  bool cover :1;
} _Calculator_addpicture_args__isset;

class Calculator_addpicture_args {
 public:

  Calculator_addpicture_args(const Calculator_addpicture_args&);
  Calculator_addpicture_args& operator=(const Calculator_addpicture_args&);
  Calculator_addpicture_args() : imagefile(), cover(0) {
  }

  virtual ~Calculator_addpicture_args() throw();
  std::string imagefile;
  int32_t cover;

  _Calculator_addpicture_args__isset __isset;

  void __set_imagefile(const std::string& val);

  void __set_cover(const int32_t val);

  bool operator == (const Calculator_addpicture_args & rhs) const
  {
  ...
  bool operator < (const Calculator_addpicture_args & ) const;
...
class Calculator_addpicture_pargs {
 public:


  virtual ~Calculator_addpicture_pargs() throw();
...
typedef struct _Calculator_addpicture_result__isset {
  _Calculator_addpicture_result__isset() : success(false) {}
  bool success :1;
} _Calculator_addpicture_result__isset;

class Calculator_addpicture_result {
 public:

  Calculator_addpicture_result(const Calculator_addpicture_result&);
  Calculator_addpicture_result& operator=(const Calculator_addpicture_result&);
  Calculator_addpicture_result() : success() {
  }

  virtual ~Calculator_addpicture_result() throw();
  std::string success;

  _Calculator_addpicture_result__isset __isset;

  void __set_success(const std::string& val);

  bool operator == (const Calculator_addpicture_result & rhs) const
  {
    if (!(success == rhs.success))
      return false;
    return true;
  ...
  bool operator < (const Calculator_addpicture_result & ) const;
...
typedef struct _Calculator_addpicture_presult__isset {
  _Calculator_addpicture_presult__isset() : success(false) {}
  bool success :1;
} _Calculator_addpicture_presult__isset;

class Calculator_addpicture_presult {
 public:


  virtual ~Calculator_addpicture_presult() throw();
  std::string* success;

  _Calculator_addpicture_presult__isset __isset;
...
class CalculatorClient : virtual public CalculatorIf, public  ::shared::SharedServiceClient {
 public:
  ...
  int32_t recv_add();
  void addpicture(std::string& _return, const std::string& imagefile, const int32_t cover);
  void send_addpicture(const std::string& imagefile, const int32_t cover);
  void recv_addpicture(std::string& _return);
  int32_t calculate(const int32_t logid, const Work& w);
...
class CalculatorProcessor : public  ::shared::SharedServiceProcessor {
 ...
 private:
  ...
  void process_addpicture(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext);
 ...
 public:
  CalculatorProcessor(boost::shared_ptr<CalculatorIf> iface) :
    ...
    processMap_["addpicture"] = &CalculatorProcessor::process_addpicture;
...
class CalculatorMultiface : virtual public CalculatorIf, public  ::shared::SharedServiceMultiface {
 ...
 public:
  ...
  void addpicture(std::string& _return, const std::string& imagefile, const int32_t cover) {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->addpicture(_return, imagefile, cover);
    }
    ifaces_[i]->addpicture(_return, imagefile, cover);
    return;
  }
...
class CalculatorConcurrentClient : virtual public CalculatorIf, public  ::shared::SharedServiceConcurrentClient {
 public:
  ...
  void addpicture(std::string& _return, const std::string& imagefile, const int32_t cover);
  int32_t send_addpicture(const std::string& imagefile, const int32_t cover);
  void recv_addpicture(std::string& _return, const int32_t seqid);
  int32_t calculate(const int32_t logid, const Work& w);
