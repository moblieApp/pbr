...
Calculator_addpicture_args::~Calculator_addpicture_args() throw() {
}


uint32_t Calculator_addpicture_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Calculator_addpicture_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Calculator_addpicture_args");

  xfer += oprot->writeFieldBegin("imagefile", ::apache::thrift::protocol::T_STRING, 1);
  xfer += oprot->writeString(this->imagefile);
  xfer += oprot->writeFieldEnd();

  xfer += oprot->writeFieldBegin("cover", ::apache::thrift::protocol::T_I32, 2);
  xfer += oprot->writeI32(this->cover);
  xfer += oprot->writeFieldEnd();
...
Calculator_addpicture_pargs::~Calculator_addpicture_pargs() throw() {
}


uint32_t Calculator_addpicture_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Calculator_addpicture_pargs");
...
Calculator_addpicture_result::~Calculator_addpicture_result() throw() {
}


uint32_t Calculator_addpicture_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Calculator_addpicture_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Calculator_addpicture_result");
...
Calculator_addpicture_presult::~Calculator_addpicture_presult() throw() {
}


uint32_t Calculator_addpicture_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void CalculatorClient::addpicture(std::string& _return, const std::string& imagefile, const int32_t cover)
{
  send_addpicture(imagefile, cover);
  recv_addpicture(_return);
}

void CalculatorClient::send_addpicture(const std::string& imagefile, const int32_t cover)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("addpicture", ::apache::thrift::protocol::T_CALL, cseqid);

  Calculator_addpicture_pargs args;
...
void CalculatorClient::recv_addpicture(std::string& _return)
{
  ...
  if (fname.compare("addpicture") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  Calculator_addpicture_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "addpicture failed: unknown result");
}
...
void CalculatorProcessor::process_addpicture(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Calculator.addpicture", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Calculator.addpicture");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Calculator.addpicture");
  }

  Calculator_addpicture_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Calculator.addpicture", bytes);
  }

  Calculator_addpicture_result result;
  try {
    iface_->addpicture(result.success, args.imagefile, args.cover);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Calculator.addpicture");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("addpicture", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Calculator.addpicture");
  }

  oprot->writeMessageBegin("addpicture", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Calculator.addpicture", bytes);
  }
}
...
void CalculatorConcurrentClient::addpicture(std::string& _return, const std::string& imagefile, const int32_t cover)
{
  int32_t seqid = send_addpicture(imagefile, cover);
  recv_addpicture(_return, seqid);
}

int32_t CalculatorConcurrentClient::send_addpicture(const std::string& imagefile, const int32_t cover)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("addpicture", ::apache::thrift::protocol::T_CALL, cseqid);
...
void CalculatorConcurrentClient::recv_addpicture(std::string& _return, const int32_t seqid)
{
